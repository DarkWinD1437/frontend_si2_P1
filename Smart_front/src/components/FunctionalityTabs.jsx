        ...
        <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-6 border border-yellow-200">
                <div className="flex items-center mb-4">
                    ...
                    <div>
                        <h5 className="text-lg font-semibold text-gray-800">T4: Asignar rol a usuario</h5>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex items-center justify-between p-2 bg-yellow-50 rounded">
                            <span className="font-mono">POST /api/users/{'{id}'}/assign-role/</span>
                            <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs">OK</span>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-yellow-50 rounded">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            ...
                            <span className="font-bold text-green-700">36+</span>
                        </div>
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <span>Tests Exitosos</span>
                            <span className="font-bold text-green-700">34+</span>
                        </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <span className="text-sm">Asignar Roles</span>
                            <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">11/11 PASS</span>
                        </div>
                    </div>
                </div>
            </div>
