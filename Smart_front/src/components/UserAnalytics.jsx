...
const UserAnalytics = () => {
    ...
    const fetchUsers = async () => {
        try {
            setLoading(true);
            // Simular datos de usuarios para frontend puro
            const userData = [
                { id: 1, role: 'admin', status: 'active', first_name: 'Carlos', last_name: 'Admin', created_at: '2024-01-15' },
                { id: 2, role: 'resident', status: 'active', first_name: 'Ana', last_name: 'García', created_at: '2024-02-10' },
                { id: 3, role: 'resident', status: 'active', first_name: 'Luis', last_name: 'Pérez', created_at: '2024-02-15' },
                { id: 4, role: 'security', status: 'active', first_name: 'Miguel', last_name: 'Security', created_at: '2024-03-01' },
                { id: 5, role: 'resident', status: 'inactive', first_name: 'Maria', last_name: 'López', created_at: '2024-03-10' },
                { id: 6, role: 'resident', status: 'active', first_name: 'Pedro', last_name: 'Ruiz', created_at: '2024-03-20' },
                { id: 7, role: 'resident', status: 'active', first_name: 'Sofia', last_name: 'Torres', created_at: '2024-04-05' },
                { id: 8, role: 'admin', status: 'active', first_name: 'Roberto', last_name: 'Admin2', created_at: '2024-04-12' },
                { id: 9, role: 'resident', status: 'active', first_name: 'Elena', last_name: 'Herrera', created_at: '2024-04-18' },
                { id: 10, role: 'security', status: 'active', first_name: 'David', last_name: 'Security2', created_at: '2024-05-01' },
            ];
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Análisis de Usuarios</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <span className="text-sm text-gray-600 mr-3">{stats.admins} usuarios</span>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-700">Residentes</span>
                        </div>
                        <div className="flex items-center">
                            <span className="text-sm text-gray-600 mr-3">{stats.residents} usuarios</span>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <span className="text-sm text-gray-600 mr-3">{stats.security} usuarios</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Estado de Actividad</h3>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div className="space-y-3">
                        <button className="w-full flex items-center justify-center px-4 py-3 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors">
                        ...
                        <button 
                            onClick={fetchUsers}
                            className="w-full flex items-center justify-center px-4 py-3 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors"
                        >
                            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
