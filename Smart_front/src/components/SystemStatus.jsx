        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                    ...
                    <div>
                        <h4 className="text-lg font-semibold text-gray-800">Estado del Sistema</h4>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex items-center justify-between">
                    <div>
                        <h5 className="font-medium text-gray-800">Estado General del Sistema</h5>
                        <p className="text-sm text-gray-600">Módulo 1 completamente operativo</p>
                    </div>
                    <div className="flex items-center space-x-2">
