                ...
                <div className="w-full max-w-2xl">
                    ...
                    <div className="px-8 py-8">
                            ...
                            {step === 1 ? (
                                <div className="space-y-6">
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-gray-600">Paso 1 de 2</p>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-medium py-3 px-4 rounded-lg transition duration-200"
                                    >
                                        Continuar
                                    </button>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div className="text-center mb-6">
                                        <h3 className="text-lg font-semibold text-gray-900">Información Personal y del Condominio</h3>
                                        <p className="text-gray-600">Paso 2 de 2 (Requerido para uso completo del sistema)</p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={handleChange}
                                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200 bg-white text-gray-700"
                                                style={{
                                            ...
                                            >
                                                <option value="CI" className="bg-white text-gray-700 py-2">Cédula de Identidad</option>
                                                <option value="PASSPORT" className="bg-white text-gray-700 py-2">Pasaporte</option>
                                                <option value="RUC" className="bg-white text-gray-700 py-2">RUC</option>
                                                <option value="NIT" className="bg-white text-gray-700 py-2">NIT</option>
                                            </select>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            >
                                                <option value="Residente" className="bg-white text-gray-700 py-2">Residente</option>
                                                <option value="Seguridad" className="bg-white text-gray-700 py-2">Personal de Seguridad</option>
                                                <option value="Administrador" className="bg-white text-gray-700 py-2">Administrador</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label htmlFor="unit_number" className="block text-sm font-medium text-gray-700 mb-2">
                                                Número de Unidad
                                                <span className="text-gray-500 text-xs ml-1">(Solo para residentes)</span>
                                            </label>
                                            <input
                                                id="unit_number"
                                                name="unit_number"
                                                ...
                                                className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200 ${
                                                    formData.role !== 'Residente' ? 'bg-gray-100 text-gray-500' : ''
                                                }`}
                                        ...
                                        <div>
                                            ...
                                            >
                                                <option value={true} className="bg-white text-gray-700 py-2">Activa</option>
                                                <option value={false} className="bg-white text-gray-700 py-2">Inactiva</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div className="mt-8 text-center">
                            <Link 
                                to="/manage-profiles" 
                                className="inline-flex items-center text-indigo-600 hover:text-indigo-500 font-medium transition duration-200"
                            >
