...
const ManageProfiles = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            ...
            console.log('Respuesta de getAllUsers en ManageProfiles:', response);
    ...
    const handleUpdateUser = async (e) => {
        ...
        try {
            ...
            setMessage({ 
                type: 'error', 
                text: error.response?.data?.message || error.response?.data?.detail || 'Error al actualizar el usuario' 
            });
        } finally {
    ...
    const handleDeleteUser = async (userId, username) => {
        const confirmMessage = `¿Estás seguro de que deseas eliminar al usuario "${username}"?\n\nEsta acción marcará el usuario como inactivo (eliminación lógica). Los datos se conservarán pero el usuario no podrá acceder al sistema.`;
        ...
        try {
            ...
            setMessage({ 
                type: 'success', 
                text: `Usuario "${username}" eliminado correctamente (eliminación lógica)` 
            });
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
                    <div className="px-6 py-8 border-b border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 text-blue-800 dark:text-blue-300 px-4 py-2 rounded-lg">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div>
                                <select
                                    ...
                                    className="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white text-sm bg-white text-gray-700"
                                    style={{
                                ...
                                >
                                    <option value="all" className="bg-white text-gray-700 py-2">Todos los roles</option>
                                    <option value="Administrador" className="bg-white text-gray-700 py-2">Administrador</option>
                                    <option value="Seguridad" className="bg-white text-gray-700 py-2">Seguridad</option>
