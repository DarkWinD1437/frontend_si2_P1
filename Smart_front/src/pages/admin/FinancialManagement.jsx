                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full">
                                ...
                                <tbody className={`${isDark ? 'bg-gray-800' : 'bg-white'} divide-y ${
                                    ...
                                    {cargos.filter(cargo => ['pendiente', 'vencido'].includes(cargo.estado))
                                           .map((cargo) => (
                                        <tr key={cargo.id}>
                ...
                {activeTab === 'reports' && (
                    <div className={`${
                        ...
                        <p className={`${
                            ...
                            Predicción de morosidad financiera y análisis predictivo. 
                            <br />
                            <span className="text-sm bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full inline-block mt-2">
                                🚧 Próximamente con IA
                            </span>
                        </p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        ...
                                        {conceptos.filter(c => c.estado === 'activo').map((concepto) => (
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {usuarios.filter(u => u.role === 'resident' || u.role === 'Residente').map((usuario) => (
