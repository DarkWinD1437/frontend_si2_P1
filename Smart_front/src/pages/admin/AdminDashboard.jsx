                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center text-sm">
                                ...
                                <span className="text-gray-400 dark:text-gray-500 ml-auto">2h</span>
                            </div>
                            <div className="flex items-center text-sm">
                                ...
                                <span className="text-gray-400 dark:text-gray-500 ml-auto">3h</span>
                            </div>
                            <div className="flex items-center text-sm">
                                ...
                                <span className="text-gray-400 dark:text-gray-500 ml-auto">5h</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600 dark:text-gray-300">Total Usuarios</span>
                                <span className="text-sm font-medium text-gray-900 dark:text-white">248</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600 dark:text-gray-300">Activos Hoy</span>
                                <span className="text-sm font-medium text-green-600 dark:text-green-400">156</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600 dark:text-gray-300">Reservas Pendientes</span>
                                <span className="text-sm font-medium text-yellow-600 dark:text-yellow-400">12</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600 dark:text-gray-300">Incidencias</span>
